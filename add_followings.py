...
with open(users_to_following_filename, 'r') as f:
...
def write_txt_users(filename, users):
    ...
    try:
        ...
        while i < max_followings and len(users_to_following) > 0:
            ...
            if api.searchUsername(users_to_following[0]):
                ...
                write_txt_users('correct_{}.txt'.format(datetime_str), correct)
        ...
        with open(users_to_following_filename, 'w') as f:
